...
## [1.4.0](https://github.com/Mininglamp-OSS/openclaw-channel-octo/compare/v1.4.1...v1.4.0) (2026-09-02)
...
* **channels-add:** add interactive wizard + non-interactive setup adapter ([aeef511](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/aeef5119dddd4da021db734cfefc73aef2ce48a3))
* **ci:** support UI-driven release flow + auto-bump package.json ([#27](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/27)) ([7519ecf](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/7519ecf6fcc611d299e5c0e5669a6a657381c704))
* ClawHub compliance - package.json, plugin.json, setup-entry, README ([45effcc](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/45effcc50215518d9d7f425a59dd3c1592fa0680))
* ClawHub compliance - package.json, plugin.json, setup-entry, README, CI ([e5c4898](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/e5c4898dec7fdd02e55fa4271c81f33ab4cd0885))
...
* **inbound:** gate on server effective (two-axis no-@ AND) ([#64](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/64)) ([493db72](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/493db72ebbcb26ec46f9dd0806a266bcc13052c1))
...
* **octo/mention:** invalidate mention-pref cache on mention_pref_updated event + drop positive TTL to 30s ([#61](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/61)) ([f6fdffa](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/f6fdffab21d12af36b5311b1fea2d682bf971c35)), closes [#60](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/60)
* **octo/mention:** 群级免@偏好 gate + pull-TTL 缓存 ([#57](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/57)) ([dab3e0a](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/dab3e0ae0b9868beb6ee36858b083d4caa125cc1))
* **octo:** rename openclaw-channel-dmwork → openclaw-channel-octo with auto-migration ([#17](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/17)) ([89d441b](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/89d441b61a587432d9f55af8e8901246ba9a7157))
...
* **richtext:** bot adapter 支持 RichText=14 图文混排 — enum+inbound+outbound+幂等 (Phase 1) ([#55](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/55)) ([e678a45](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/e678a45b28f5dfe70ff5d792acd3824e0e5f886f))
* sync runtime fixes and features from octo-adapters (PR [#27](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/27) [#45](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/45) [#55](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/55) [#61](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/61) [#65](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/65) [#69](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/69)) ([#24](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/24)) ([782a447](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/782a4472ca3dfa6fe145cd737634e6a1fac94d38))
...
* address codex review findings (3 MAJOR + 2 MINOR) ([024dc97](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/024dc97bec50282708620b5ad0bc1d549d9eed33))
* address codex round 3 MINOR findings ([69168e6](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/69168e669f852940eb0b68bc8e044ba5a1d48516))
* address PR review feedback (P1 + P2) ([5b42c5d](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/5b42c5d3f1b6f523eb127c890504d2df91da2e4b))
* address PR review findings (codex + yujiawei) ([898917f](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/898917fbb7038da1d6c43685ab41da89c0c15ea3))
...
* **channels-add:** wire bundled setup entry + align plugin id with channel id ([c99bb24](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/c99bb24d2f37ef19b21bb153eb02c7362182fe4c))
...
* **ci:** finalize PR notification design — remove octo-pr-feed, fix result-notify ([#47](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/47)) ([d4fbb56](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/d4fbb56a6f29c6045a225b51a4e3bf73dfc414d9))
* **ci:** handle release-drafter race in publish-clawhub workflow ([b40f499](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/b40f499e19a9751ef8efdf024512ead37208689c))
* **ci:** 修复 publish-clawhub.yml 注释里的 GHA 表达式被错误解析 ([5c3ca2d](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/5c3ca2d6a0bca7b5098021adf7a10f6075e6649b))
* **ci:** 修复 publish-clawhub.yml 注释里的 GHA 表达式被错误解析 ([9d5c3b9](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/9d5c3b92013559dfd5a3f7357f7171bf44857d65))
* **clawhub:** resolve P2 polish items — socket bug + meta + docs ([3e87fb2](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/3e87fb241aeb9e0bcc9876f11ebde4db8c24d8bf))
* **clawhub:** unblock ClawHub publication — build + traversal + manifest ([ff060a5](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/ff060a50c68863940585afee445adcc035cf1054))
* **clawhub:** unblock ClawHub publication — P1 + P2 fixes ([b46fcfb](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/b46fcfb46d6726d3ea40d32608b7d868d0d735e9))
...
* migrate octo_management to registerTool for accountId resolution ([#37](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/37)) ([08a1940](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/08a1940f1fee693aab9089477a2010a6ba43effd))
* move permissions to workflow top level for pr-contributor-welcome ([#36](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/36)) ([e516d37](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/e516d3784709b4ea21d812e2d257ec85c2d9490c))
...
* **outbound:** propagate Octo message_id to OutboundDeliveryResult and toolResult ([#53](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/53)) ([0ce63b3](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/0ce63b34e76a57890d33b80f16d0c4affc288006)), closes [#51](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/51)
...
* **persona:** inject cached persona_prompt into group-path GroupSystemPrompt ([#28](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/28)) ([13631b6](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/13631b6cfae4227e649cb65799d67155c0ee6544))
* **persona:** inject cached persona_prompt into group-path GroupSystemPrompt ([#29](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/29)) ([74e1b67](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/74e1b67199d812be4310bfba40d0accd33143fef))
...
* register SessionBindingAdapter for ACP thread binding ([#32](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/32)) ([ff301c3](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/ff301c329130458a4a735fce0ac863b4f4d4b8fb))
* **register:** drop duplicate registerChannel/setRuntime in registerFull ([7daac68](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/7daac6845f7067dee95f1af977a5c92f8e38a3c5))
* **register:** guard registerFull to full mode only; fix misleading comment ([d2a9616](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/d2a961606f6c254ac1d08e60a8034e9b4356b0d9))
* **register:** restore manual setOctoRuntime + registerChannel; bump 1.0.5 ([074542f](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/074542f701bfce6debfebbf132fbaadabebd84a2))
* **release:** address codex MAJOR/MINOR findings on plugin id and setup defaults ([f8569ba](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/f8569ba0b0eae28d091582d0af12c45713ea92c7))
* **release:** address codex round 2 findings — npm artifact mismatch + npm-only update check + stale skill docs ([7322dfb](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/7322dfb5543dbddef0a3d69192d6018072c696a4))
* **release:** drop child_process from runtime to pass OpenClaw ClawScan install gate (1.0.1 → 1.0.2) ([d94612f](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/d94612f3fe65ad3ec14d887df143463f73c5a5e6))
...
* **runtime:** wire setOctoRuntime into both bundled entries to fix "Octo runtime not initialized" on first inbound (1.0.2 → 1.0.3) ([068a26d](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/068a26da1a123cfea372d7d332763eb7f04ecf7e))
* **security:** harden workflow_dispatch input against shell injection ([89068bd](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/89068bd4a17b9d069697863061f511147e19f6ed))
...
* support multiple attachments in message action send ([#26](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/26)) ([8230c37](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/8230c3718e6cf1f687c8eeb3e8672463aa8da204))
...
* **octo/mention:** drop mentionAll trigger, gate on mention.ais only ([#50](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/50)) ([1cb1b6e](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/1cb1b6e31388d1aaed5e068986a3374460b8b35d)), closes [#107](https://github.com/Mininglamp-OSS/openclaw-channel-octo/issues/107)
...
* rename internal dmwork* identifiers to octo* + drop remaining legacy compat ([236c7c3](https://github.com/Mininglamp-OSS/openclaw-channel-octo/commit/236c7c3009165266bdc839fe1c7e39c1f84d631f))
